...
theme.bg_normal     = "#ffffffcc"   -- "#000000cc"   -- "#1c1c1c99"
theme.bg_focus      = "#7985A366"
theme.bg_urgent     = "#ad3737"     -- "#A3666666"
--theme.bg_minimize   = "#444444"
--theme.bg_systray    = theme.bg_normal

theme.fg_normal     = "#000000"     -- "#C5C5C5"
theme.fg_focus      = "#E4E4E4"
theme.fg_urgent     = "#ffffff"     -- "#A36666"
--theme.fg_minimize   = "#ffffff"

theme.border_width  = 7
theme.border_normal = "#5c5dadcc" -- "#c9c925cc"
theme.border_focus  = "#c9c925cc" -- "#5c5dadcc"
...
theme.menu_bg_normal = "#ffffff44"   -- "#454545"
